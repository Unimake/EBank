...
// ============================================================================
// ConsultarBoleto.prg
// Padrao baseado no RegistrarBoleto.prg:
...
// Summary: Consulta boletos e retorna o hash/array da resposta.
...
// Summary: Envia a consulta de boletos e retorna o JSON decodificado.
// Params:
...
FUNCTION ConsumirAPIConsultarBoleto( cToken )
	...
	BEGIN SEQUENCE
		...
		cUrl := IF( nAmbiente == 1, ;
			"https://unimake.app/ebank/api/v1/boleto/consultar?configurationId=", ;
			"https://ebank.sandbox.unimake.software/api/v1/boleto/consultar?configurationId=" ) + cConfigurationID
	...
	// ==============================
	// Tratamento de erros (padrao RegistrarBoleto)
	// ==============================
	IF Empty( cConfigRaw )
...
// Summary: Monta o JSON da consulta de boletos.
...
// Summary: Trata o retorno da consulta e exibe dados basicos.
STATIC FUNCTION ProcessarRetornoConsultaBoleto( xJson )
	...
	FOR nI := 1 TO Len( aBoletos )
		...
		cInfo := "Boleto #" + LTrim( Str( nI ) ) + CRLF + ;
			"Codigo de Barras: " + cCodigoBarras + CRLF + ;
			"Situacao: " + cSituacao + CRLF + ;
			"Tipo de Liquidacao: " + cTipoLiquidacao + CRLF + ;
			"Linha Digitavel: " + cLinhaDigitavel + CRLF + ;
			"Valor: R$ " + cValor + CRLF + ;
			"Desconto: R$ " + cValorDesconto + CRLF + ;
			"Juros: R$ " + cValorJuros + CRLF + ;
			"Valor Liquidado: R$ " + cValorLiquidado
