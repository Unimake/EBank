...
namespace Unimake.EBank.Solutions.Converters.Json
{
    ...
    /// </summary>
    public sealed class ExtratoConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            if(objectType == typeof(global::EBank.Solutions.Primitives.CNAB.CNAB240.Contract.ILote))
            {
                type = typeof(global::EBank.Solutions.Primitives.CNAB.CNAB240.Extrato.LoteDeExtratoDeContaCorrente);
                    ...
                    objectType == typeof(global::EBank.Solutions.Primitives.CNAB.Contract.ICNABItem))
            {
                type = jObject.SelectToken("Servico.Segmento").ToString() == "E" ?
                            typeof(global::EBank.Solutions.Primitives.CNAB.CNAB240.Extrato.Registro.DetalheSegmentoE) :
                            Type.GetType($"EBank.Solutions.Primitives.CNAB.CNAB240.Extrato.Registro.DetalheSegmento{jObject.SelectToken("Servico.Segmento")}, EBank.Solutions.Primitives");
            }
